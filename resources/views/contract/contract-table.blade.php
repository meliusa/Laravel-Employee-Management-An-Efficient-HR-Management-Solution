            ...
            <div class="toolbar" id="kt_toolbar">
                ...
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <!--begin::Title-->
                        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Tipe Kontrak</h1>
                        <!--end::Title-->
                        <!--begin::Separator-->
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-dark">Tipe Kontrak</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                <!--begin::Form-->
                                                <form id="kt_modal_add_contract" class="form"
                                                    action="{{ route('contract.store') }}" method="POST">
                                                    @csrf
                                                    <!--begin::Scroll-->
                                                    <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <!--begin::Label-->
                                                            <label class="required fw-bold fs-6 mb-2">Tipe Kontrak</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" name="tipe_kontrak"
                                                        ...
                                                        <div class="row mb-7">
                                                            <div class="col-md-6 fv-row">
                                                                <label for=""
                                                                    class="required form-label">Durasi</label>
                                                                <input class="form-control form-control"
                                                                    placeholder="Durasi" name="durasi" />
                                                            </div>
                                                            <div class="col-md-6 fv-row">
                                                                <label for="" class="form-label col-form-label"></label>
                                                                <div class="form-control form-control-transparent">Bulan</div>
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                    </div>
