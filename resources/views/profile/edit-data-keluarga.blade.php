        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ubah Data Keluarga</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Ubah Data Keluarga</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                            ...
                            <form action="{{ route('family.update', $family->id) }}" method="POST">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="hidden" name="id" id="keluarga" value="{{ $family->id }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control  mb-3" id=""
                                            placeholder="Nomor KK" name="no_kk" value="{{ $family->no_kk }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-12">
                                                <input name="provinsi" type="text" class="form-control"
                                                    placeholder="Provinsi" value="{{ $family->provinsi }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="col-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-12">
                                                <input name="kecamatan" type="text" class="form-control"
                                                    placeholder="Kecamatan" value="{{ $family->kecamatan }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="col-12">
                                                <input name="desa/kelurahan" type="text" class="form-control"
                                                    placeholder="Kelurahan" value="{{ $family['desa/kelurahan'] }}" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-12">
                                                <input name="alamat" type="text" class="form-control"
                                                    placeholder="Jalan" value="{{ $family->alamat }}" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-12">
                                                <input name="rt" type="text" class="form-control"
                                                    placeholder="RT" value="{{ $rt }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="col-12">
                                                <input name="rw" type="text" class="form-control"
                                                    placeholder="RW" value="{{ $rw }}" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-12">
                                                <input name="kode_pos" type="text" class="form-control"
                                                    placeholder="Kode Pos" value="{{ $family->kode_pos }}" />
                                            </div>
                                        </div>
                                    </div>
