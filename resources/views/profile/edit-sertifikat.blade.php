        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ubah Sertifikat</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Ubah Sertifikat</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div id="kt_docs_repeater_advanced" class="collapse show">
                            ...
                            <form action="{{ route('certificate.update', $certificate->id) }}" method="POST">
                                ...
                                <div class="card-body border-top p-9">
                                    <!--begin::Input group-->
                                    <input type="hidden" name="id" id="sertifikat" value="{{ $certificate->id }}">
                                    ...
                                    <div class="col-lg-12 fv-row">
                                        ...
                                        <div class="fv-row">
                                            <!--begin::Dropzone-->
                                            <div class="dropzone" id="single-certificate">
                                                <!--begin::Message-->
