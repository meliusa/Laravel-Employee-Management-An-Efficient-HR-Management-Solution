            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Tambah Karyawan</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div id="kt_content_container" class="container-xxl">
                    <div class="form-wizard">
                        <div class="form-wizard-header">
                            <ul class="list-unstyled mt-0 form-wizard-steps clearfix d-flex justify-content-center">
                                <li class="active">
                                    <span>1</span>
                                </li>
                                <li><span>2</span></li>
                        ...
                        <form method="POST" action="{{ route('employee.store') }}" enctype="multipart/form-data">
                            ...
                            @include('employee.data.personal-data')

                            @include('employee.data.family-data')

                            @include('employee.data.employment-history')

                            @include('employee.data.certificate')

                            @include('employee.data.salary-data')
