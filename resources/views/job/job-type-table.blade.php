            ...
            <div class="toolbar" id="kt_toolbar">
                ...
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <!--begin::Title-->
                        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Data Tipe Pekerjaan</h1>
                        <!--end::Title-->
                        <!--begin::Separator-->
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-dark">Tipe Pekerjaan</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_job_type">
                                ...
                                <form action="{{ route('job-type.store') }}" method="POST">
                                    @csrf
                                    <div class="modal fade" id="kt_modal_add_job_type" tabindex="-1" aria-hidden="true">
                                        <!--begin::Modal dialog-->
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                    <!--begin::Form-->
                                                    <form id="kt_modal_add_job_position_form" class="form" action="#">
                                                        <!--begin::Scroll-->
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                                            <!--begin::Input group-->
                                                            <div class="fv-row mb-7">
                                                                <!--begin::Label-->
                                                                <label class="required fw-bold fs-6 mb-2">Tipe
                                                                    Pekerjaan</label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Tipe Pekerjaan</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <form class="form-delete"
                                                    action="{{ route('job-type.destroy', $job->id) }}" method="post">
                                                    @method('delete')
                                                    @csrf
