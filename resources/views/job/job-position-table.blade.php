            ...
            <div class="toolbar" id="kt_toolbar">
                ...
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    ...
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <!--begin::Title-->
                        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Data Posisi Pekerjaan</h1>
                        <!--end::Title-->
                        <!--begin::Separator-->
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-dark">Posisi Pekerjaan</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_job_position">
                                        Tambah Data</button>
                                </div>
                                <!--end::Toolbar-->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                ...
                                                <form id="kt_modal_add_job_position_form" class="form"
                                                    action="{{ route('job-position.store') }}" method="POST">
                                                    @csrf
                                                    <!--begin::Scroll-->
                                                    <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <!--begin::Label-->
                                                            <label class="fw-bold fs-6 mb-2">Posisi Pekerjaan</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tbody class="text-gray-600 fw-bold">
                                    @foreach ($jobPositions as $posisi)
                                        <!--begin::Table row-->
                                        <tr>
                                            <!--begin::Job=-->
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <form class="form-delete"
                                                    action="{{ route('job-position.destroy', $posisi->id) }}"
                                                    method="post">
                                                    @method('delete')
                                                    @csrf
